...
if(nonempty_lines GREATER capability_adjusted_limit)
    message(FATAL_ERROR
        ...
        "${hex20_finite_sliding_contact_lines} lines for HEX20 finite-sliding current-configuration search and history"
    )
endif()
...
message(STATUS
    ...
    "${hex20_finite_sliding_contact_lines} HEX20 finite-sliding current-configuration search and history lines"
)
