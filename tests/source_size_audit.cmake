...
if(nonempty_lines GREATER capability_adjusted_limit)
    message(FATAL_ERROR
        ...
        "${hex20_surface_mechanical_contact_lines} lines for HEX20 surface-to-surface mechanical contact"
    )
endif()
...
message(STATUS
    ...
    "${hex20_surface_mechanical_contact_lines} HEX20 surface-to-surface mechanical-contact lines"
)
