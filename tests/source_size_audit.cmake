...
if(nonempty_lines GREATER capability_adjusted_limit)
    message(FATAL_ERROR
        ...
        "${hex20_small_sliding_surface_contact_lines} lines for reference-segmented HEX20 small-sliding contact"
    )
endif()
...
message(STATUS
    ...
    "${hex20_small_sliding_surface_contact_lines} reference-segmented HEX20 small-sliding contact lines"
)
