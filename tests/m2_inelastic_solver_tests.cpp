...
bool test_j2_moose_comparison(const std::string& input_path, const std::string& nodal_reference_path) {
    ...
    passed = check_scalar_metrics("m22_j2_axial_stress", axial_stress, moose_axial_stress, moose_relative_tolerance) &&
             passed;
    passed = check_scalar_metrics("m22_j2_equivalent_plastic", equivalent_plastic, moose_equivalent_plastic,
                                  moose_relative_tolerance) &&
             passed;
    passed = check_scalar_metrics("m22_j2_top_displacement", top_displacement, moose_top_displacement,
                                  moose_relative_tolerance) &&
             passed;
...
bool test_j2_unload_reload_moose_comparison(const std::string& input_path, const std::string& nodal_reference_path,
    ...
    passed = check_history_metrics("m22_j2_unload_reload_axial_displacement", axial_displacement,
    ...
    passed =
        ...
        passed;
    passed = check_history_metrics("m22_j2_unload_reload_effective_plastic", effective_plastic,
    ...
    passed =
        ...
        passed;
    passed = check_history_metrics("m22_j2_unload_reload_radial_plastic", radial_plastic, moose_relative_tolerance,
                                   1.0e-14) &&
             passed;
...
bool test_norton_moose_comparison(const std::string& input_path, const std::string& nodal_reference_path) {
    ...
    passed =
        ...
        passed;
    passed = check_scalar_metrics("m22_norton_equivalent_creep", equivalent_creep, moose_equivalent_creep,
                                  moose_relative_tolerance) &&
             passed;
    passed = check_scalar_metrics("m22_norton_top_displacement", top_displacement, moose_top_displacement,
                                  moose_relative_tolerance) &&
             passed;
...
bool test_coupled_moose_comparison(const std::string& displacement_input, const std::string& traction_input,
    ...
    passed = check_scalar_metrics("m22_coupled_traction_axial_stress", axial_stress, moose_axial_stress,
                                  moose_relative_tolerance) &&
             passed;
    ...
    passed = check_scalar_metrics("m22_coupled_displacement_axial_stress", average_axial_stress(displacement),
             ...
             passed;
    passed =
        check_scalar_metrics("m22_coupled_displacement_equivalent_plastic", average_equivalent_plastic(displacement),
                             displacement_moose_plastic, moose_relative_tolerance) &&
        passed;
