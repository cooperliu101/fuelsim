...
bool run_tests(const std::string& steady_path, const std::string& transient_path, const std::string& finite_strain_path,
               const std::string& scaled_displacement_path, const std::string& traction_path,
    ...
    passed = expect_registered_case_failure(malformed_path, missing_material_parameter, custom_registry,
    ...
    m3_case.replace(plastic_function_position, plastic_function.size(),
