...
int main(int argc, char** argv) {
    ...
    try {
        ...
        const std::set<std::string> required_ids = {
            ...
            "thermal.contact",
            "thermal.mpi",
            "thermal.interface_and_properties",
            "thermal.production_restart",
            "thermal.multimaterial_energy",
            "thermal.analytic_representatives",
            "thermal.curved_nonmatching",
            "thermal.interface_adaptive_restart",
            "gps.local",
            "mass.gravity_local",
            "gravity.hex8",
            "gravity.hex20",
            ...
            "gps.chain_abaqus",
            "gps.chain_finite",
            "gps.inelastic_finite",
            "gps.transactions",
            "gps.scope",
            "elements.cax4t",
            "cax4t.material_temperature",
            "elements.local_kernels",
        ...
        if (verified != 197 || qualified != 25 || measured != 12 || limitations != 5 || unverified != 0)
