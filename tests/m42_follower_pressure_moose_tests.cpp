...
bool run_comparison(const std::string& input_path,
    ...
    bool passed = check(result.completed && result.solve.converged,
                        "M4.2 follower-pressure solve converged");
    ...
    passed = check(fuelsim::test::relative_metrics_below(
             ...
             passed;
    fuelsim::test::print_relative_metrics("m42_temperature",
                                          fields.temperature);
    fuelsim::test::print_relative_metrics("m42_radial_displacement",
                                          fields.radial_displacement);
    fuelsim::test::print_relative_metrics("m42_axial_displacement",
