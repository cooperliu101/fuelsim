...
bool check_hex20_friction_path_33(const std::string& output_path,
    const std::string& displacement_path,
    const std::string& contact_path,
...
bool check_hex20_nonmatching(const std::string& output,
    const std::string& displacement_path,
    const std::string& reaction_path,
