#!/usr/bin/env python3
"""Generate the B5.12 active small-strain coupled plastic-creep C3D8T probe."""

from pathlib import Path


DISPLACEMENTS = (0.0015, 0.0020, 0.0025, 0.0030, 0.0035, 0.0040, 0.0045, 0.0050, 0.0055, 0.0060)


def step_lines(index, displacement):
    return [
        "*Step, name=STEP%d, nlgeom=NO, inc=16" % index,
...
def deck():
    lines = [
        "*Heading",
        "** B5.12 Abaqus/Standard small-strain active coupled J2 plasticity-Norton creep C3D8T probe.",
        ...
        "1, 4, 1",
        "*Material, name=COUPLED_MATERIAL",
        "*Elastic",
        ...
        "*Specific Heat",
        "1.0",
        "*Solid Section, elset=VOLUME, material=COUPLED_MATERIAL",
        ",",
...
if __name__ == "__main__":
    output = Path(__file__).with_name("b512_hex8_c3d8t_small_coupled.inp")
