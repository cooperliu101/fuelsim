...
if len(sys.argv) != 5:
    raise RuntimeError("usage: extract_b512.py <job.odb> <nodal.csv> <integration.csv> <energy.csv>")
...
try:
    ...
    for stage in range(1, 11):
        ...
        fields = {}
        for name in ("CE", "CEEQ", "COORD", "EE", "IVOL", "PE", "PEEQ", "S", "TEMP"):
            fields[name] = {
