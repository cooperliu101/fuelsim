...
projection. Fuelsim rejects the same state because the contact was reactivated
immediately beforehand and every activated constraint has left the complete
primary surface. This is a qualified semantic boundary: Abaqus naturally
releases, whereas Fuelsim preserves its explicit lost-projection guard.
