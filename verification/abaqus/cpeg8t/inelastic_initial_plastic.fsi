...
[Outputs]
  console = true
  exodus = inelastic_initial_plastic_results.e
  history = inelastic_initial_plastic_history.csv
  checkpoint = inelastic_initial_plastic.chk
[]
