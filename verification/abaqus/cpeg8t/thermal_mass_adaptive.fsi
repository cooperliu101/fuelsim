...
[Executioner]
  ...
  strain_history_time_absolute_tolerance = 1e-6
...
[Outputs]
  console = true
  exodus = thermal_mass_adaptive_results.e
  history = thermal_mass_adaptive_history.csv
  checkpoint = thermal_mass_adaptive.chk
