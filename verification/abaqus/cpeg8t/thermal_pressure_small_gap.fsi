...
[Mesh]
type = exodus
file = contact_small_gap.e
[]
[TimeFunctions]
  [motion]
  type = piecewise_linear
  times = 0 0.25 0.5 0.75 1
  values = 0 0 -0.000011 0 0
  []
  [hot]
  type = piecewise_linear
  times = 0 1
...
[Outputs]
console = true
exodus = thermal_pressure_small_gap_results.e
history = thermal_pressure_small_gap_history.csv
checkpoint = thermal_pressure_small_gap.chk
[]
