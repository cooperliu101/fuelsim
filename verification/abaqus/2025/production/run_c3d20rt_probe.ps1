...
Set-Location $Work
& "C:\SIMULIA\Commands\abq2025.bat" "job=$JobName" "input=${JobName}.inp" cpus=1 output_precision=full ask_delete=OFF interactive
...
& "C:\SIMULIA\Commands\abq2025.bat" python extract_c3d20rt_probe.py "${JobName}.odb" "${JobName}_nodes.csv"
