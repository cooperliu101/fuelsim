# M3.3 nonmatching multi-contact verification: the three independent blocks use
# different axial subdivisions on the two radial contact interfaces. The same
# generated Exodus mesh is read by fuelsim for the comparison.
