# M3.3 multi-contact verification: three independent axisymmetric blocks with
# two radial mechanical contact pairs.  The same generated Exodus mesh is read
# by fuelsim for the comparison.
