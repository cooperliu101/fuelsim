...
[Outputs]
  console = true
  csv = transient_c3d20rt_finite_contact_disk_first_summary.csv
  exodus = transient_c3d20rt_finite_contact_disk_first_results.e
  exodus_interval = 1
  checkpoint = c3d20rt_finite_contact_disk_first.checkpoint
