...
[Executioner]
  type = transient
  restart = transient_gps_initial_mass_checkpoint.checkpoint
  end_time = 1
...
[Outputs]
  console = true
  csv = transient_gps_initial_mass_restart_summary.csv
  exodus = transient_gps_initial_mass_restart_results.e
  history = transient_gps_initial_mass_restart_history.csv
  checkpoint = transient_gps_initial_mass_restart.checkpoint
[]
