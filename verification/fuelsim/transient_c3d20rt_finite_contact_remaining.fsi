...
[Executioner]
  type = transient
  end_time = 7
  restart = ../abaqus/c3d20rt_failed_385.checkpoint
...
[Outputs]
  console = true
  csv = transient_c3d20rt_finite_contact_remaining_summary.csv
  exodus = transient_c3d20rt_finite_contact_remaining_results.e
  exodus_interval = 1
  checkpoint = c3d20rt_finite_contact_remaining.checkpoint
