...
[Outputs]
  console = true
  csv = transient_gps_material_temperature_finite_summary.csv
  exodus = transient_gps_material_temperature_finite_results.e
  history = transient_gps_material_temperature_finite_history.csv
  checkpoint = transient_gps_material_temperature_finite.checkpoint
[]
