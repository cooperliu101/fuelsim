...
[Outputs]
  console = true
  csv = transient_gps_initial_mass_checkpoint_summary.csv
  exodus = transient_gps_initial_mass_checkpoint_results.e
  history = transient_gps_initial_mass_checkpoint_history.csv
  checkpoint = transient_gps_initial_mass_checkpoint.checkpoint
[]
