...
[Materials]
  ...
  [secondary]
    ...
    [plasticity]
      ...
      hardening_temperature_coefficient = -5000
    []
    [creep]
      ...
      stress_exponent = 3
      reference_temperature = 300
      coefficient_temperature_coefficient = 2e-7
      reference_stress_temperature_coefficient = 0
      stress_exponent_temperature_coefficient = 0
    []
  []
[]
[Regions]
...
[Outputs]
  console = false
  csv = transient_b523_integrated_contact_summary.csv
  exodus = transient_b523_integrated_contact_results.e
[]
