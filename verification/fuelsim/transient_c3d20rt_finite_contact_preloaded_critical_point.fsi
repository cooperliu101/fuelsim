...
[Executioner]
  type = transient
  end_time = 7
  restart = ../abaqus/c3d20rt_accepted_first_increment.checkpoint
...
[Outputs]
  console = true
  csv = transient_c3d20rt_finite_contact_preloaded_critical_point_summary.csv
  exodus = transient_c3d20rt_finite_contact_preloaded_critical_point_results.e
  exodus_interval = 1
  checkpoint = c3d20rt_finite_contact_preloaded_critical_point.checkpoint
