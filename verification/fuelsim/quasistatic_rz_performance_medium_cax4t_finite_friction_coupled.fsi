# Finite-strain CAX4T: 20 equilibrium increments with committed material history.
# Transient thermal storage and coupled cladding creep/plasticity are active.
[Case]
  version = 3
  problem = transient
...
[Outputs]
  console = true
  exodus = quasistatic_rz_performance_medium_cax4t_finite_friction_coupled_results.e
  csv = quasistatic_rz_performance_medium_cax4t_finite_friction_coupled_summary.csv
[]
