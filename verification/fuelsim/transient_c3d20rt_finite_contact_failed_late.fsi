...
[Executioner]
  type = transient
  end_time = 4.88125
  restart = ../abaqus/c3d20rt_failed_4878125.checkpoint
  initial_time_step = 0.025
  minimum_time_step = 0.003125
...
[Outputs]
  console = true
  csv = transient_c3d20rt_finite_contact_failed_late_summary.csv
  exodus = transient_c3d20rt_finite_contact_failed_late_results.e
  exodus_interval = 1
  checkpoint = c3d20rt_finite_contact_failed_late.checkpoint
