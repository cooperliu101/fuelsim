# Steady finite-strain CAX4T performance case: explicit production input, SI units.
[Case]
  version = 3
  problem = steady
...
[Outputs]
  console = true
  exodus = steady_rz_performance_medium_cax4t_finite_results.e
  csv = steady_rz_performance_medium_cax4t_finite_summary.csv
[]
