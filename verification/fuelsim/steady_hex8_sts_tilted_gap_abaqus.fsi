...
[Mesh]
  type = exodus
  file = ../abaqus/b39_hex8_sts_tilted_gap_mesh.e
[]
...
[BoundaryConditions]
  ...
  [primary_displacement_2]
    ...
    value = 0
  []
  [secondary_displacement_0]
    type = dirichlet
    boundary = secondary_outer
    field = displacement_x
    value = -1.08756934444398e-05
    scale_with_load = true
  []
  [secondary_displacement_1]
    type = dirichlet
    boundary = secondary_outer
    field = displacement_y
    value = -5.071419140888393e-06
    scale_with_load = true
  []
  [secondary_displacement_2]
    type = dirichlet
    boundary = secondary_outer
    field = displacement_z
    value = 0
...
[Outputs]
  console = true
  csv = steady_hex8_sts_tilted_gap_abaqus_summary.csv
  exodus = steady_hex8_sts_tilted_gap_abaqus_results.e
[]
