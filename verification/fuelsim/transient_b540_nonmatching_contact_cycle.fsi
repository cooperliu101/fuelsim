...
[Mesh]
  type = exodus
  file = ../meshes/b540_nonmatching_contact_cycle.e
[]
[Materials]
  [primary]
    [thermal]
...
[TimeFunctions]
  [secondary_temperature]
    ...
    times = 0 0.08 0.10 0.18 0.20 0.40 0.48 0.50 0.58 0.60 0.80 0.88 0.90
    values = 300 308 310 310 310 310 310 310 310 310 310 310 310
  []
  [normal_x]
    type = piecewise_linear
    times = 0 0.08 0.10 0.18 0.20 0.40 0.48 0.50 0.58 0.60 0.80 0.88 0.90
    values = 0 0 -0.0005 -0.0005 0 0 0 -0.0005 -0.0005 0 0 0 -0.0005
  []
  [tangential_y]
    type = piecewise_linear
    times = 0 0.08 0.10 0.18 0.20 0.40 0.48 0.50 0.58 0.60 0.80 0.88 0.90
    values = 0 0.04 0.05 0.05 0.05 0.95 0.95 0.95 0.95 0.95 0.05 0.05 0.05
  []
  [tangential_z]
    type = piecewise_linear
    times = 0 0.08 0.10 0.18 0.20 0.40 0.48 0.50 0.58 0.60 0.80 0.88 0.90
    values = 0 0.032 0.04 0.04 0.04 0.20 0.20 0.20 0.20 0.20 0.40 0.40 0.40
  []
[]
[Contact]
  [coupled_contact]
...
[BoundaryConditions]
  ...
  [secondary_tangential_y]
    type = dirichlet
    boundary = secondary_all_surface
    field = displacement_y
    value = 1
...
[Outputs]
  console = false
  csv = transient_b540_nonmatching_contact_cycle_summary.csv
  exodus = transient_b540_nonmatching_contact_cycle_results.e
[]
