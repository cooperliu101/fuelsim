...
[Outputs]
  console = true
  csv = transient_gps_thermal_finite_summary.csv
  exodus = transient_gps_thermal_finite_results.e
  history = transient_gps_thermal_finite_history.csv
  checkpoint = transient_gps_thermal_finite.checkpoint
[]
