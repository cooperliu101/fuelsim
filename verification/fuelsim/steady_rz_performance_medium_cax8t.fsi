# Steady CAX8T performance case: explicit production input, SI units.
[Case]
  version = 3
  problem = steady
...
[Outputs]
  console = true
  exodus = steady_rz_performance_medium_cax8t_results.e
  csv = steady_rz_performance_medium_cax8t_summary.csv
[]
