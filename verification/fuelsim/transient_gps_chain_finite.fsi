...
[Outputs]
  console = true
  csv = transient_gps_chain_finite_summary.csv
  exodus = transient_gps_chain_finite_results.e
  history = transient_gps_chain_finite_history.csv
  checkpoint = transient_gps_chain_finite.checkpoint
[]
