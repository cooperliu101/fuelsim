...
[Executioner]
  type = transient
  restart = transient_gps_contact_checkpoint.checkpoint
  end_time = 10
  initial_time_step = 1
  minimum_time_step = 1
  maximum_time_step = 1
...
[Outputs]
  console = true
  csv = transient_gps_contact_restart_summary.csv
  exodus = transient_gps_contact_restart_results.e
  history = transient_gps_contact_restart_history.csv
  checkpoint = transient_gps_contact_restart.checkpoint
[]
