...
[Outputs]
  console = true
  csv = transient_hex20_sts_quadratic_cylinder_friction_path_abaqus_summary.csv
  exodus = transient_hex20_sts_quadratic_cylinder_friction_path_abaqus_results.e
  exodus_interval = 10
[]
