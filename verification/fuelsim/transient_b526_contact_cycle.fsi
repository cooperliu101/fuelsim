...
[Mesh]
  type = exodus
  file = ../meshes/b526_contact_cycle.e
[]
[Materials]
  [primary]
    [thermal]
...
[TimeFunctions]
  [secondary_temperature]
    ...
    values = 300 301 301 301 301
  []
  [normal_x]
    type = piecewise_linear
    times = 0 0.1 0.2 0.3 0.4
    values = 0 -0.0002 0 -0.0002 -0.0002
  []
[]
[Contact]
  [coupled_contact]
...
[Outputs]
  console = false
  csv = transient_b526_contact_cycle_summary.csv
  exodus = transient_b526_contact_cycle_results.e
[]
