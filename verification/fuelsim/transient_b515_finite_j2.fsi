...
[TimeFunctions]
  [right_displacement]
    ...
    values = 0 0.0005 0.002 0.004 0.002 0 -0.002 -0.004 -0.001 0.003 0
  []
[]
[BoundaryConditions]
  [temperature]
...
[Outputs]
  console = true
  csv = transient_b515_finite_j2_summary.csv
  exodus = transient_b515_finite_j2_results.e
  checkpoint = transient_b515_finite_j2.checkpoint
[]
