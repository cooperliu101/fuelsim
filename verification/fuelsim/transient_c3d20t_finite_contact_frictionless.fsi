...
[Outputs]
  console = true
  csv = transient_c3d20t_finite_contact_frictionless_summary.csv
  exodus = transient_c3d20t_finite_contact_frictionless_results.e
  exodus_interval = 1
  checkpoint = c3d20t_finite_contact_frictionless.checkpoint
