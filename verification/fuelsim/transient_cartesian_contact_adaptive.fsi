...
[Executioner]
  ...
  minimum_time_step = 0.00001
  maximum_time_step = 0.4
  growth_factor = 1
  cutback_factor = 0.5
  maximum_cutbacks = 20
  adaptive_algorithm = step_doubling
  time_error_relative_tolerance = 0.001
...
[Outputs]
  console = true
  csv = transient_cartesian_contact_adaptive_summary.csv
  exodus = transient_cartesian_contact_adaptive_results.e
[]
