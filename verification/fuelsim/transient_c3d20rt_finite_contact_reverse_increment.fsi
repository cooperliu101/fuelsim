...
[Executioner]
  type = transient
  end_time = 4.025
  restart = ../abaqus/c3d20rt_failed_critical_point_4.checkpoint
...
[Outputs]
  console = true
  csv = transient_c3d20rt_finite_contact_reverse_increment_summary.csv
  exodus = transient_c3d20rt_finite_contact_reverse_increment_results.e
  exodus_interval = 1
  checkpoint = c3d20rt_finite_contact_reverse_increment.checkpoint
