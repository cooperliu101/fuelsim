...
def benchmark(executable, directory, cpu, repeats):
    ...
    for repeat in range(1, repeats + 1):
        ...
        order = ('solid', 'modal') if repeat % 2 else ('modal', 'solid')
        for kind in order:
            ...
            records.append(dict(repeat=repeat, model=kind, cpu=cpu, **values))
...
if __name__ == '__main__':
    ...
    benchmark(args.executable, args.directory, args.cpu, args.repeats)
