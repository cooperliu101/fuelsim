...
class Hex8ThermoelasticKernel final {
  ...
  private:
    void residual_ad(const Hex8Geometry& geometry, const Hex8LocalAdValues& state, Hex8LocalAdValues& residual) const;
...
class Hex8TransientKernel final {
  public:
    Hex8TransientKernel(IsotropicThermoelasticMaterial material, double constant_heat_capacity,
  ...
  private:
    void residual_ad(const Hex8Geometry& geometry, const Hex8LocalAdValues& current_state,
