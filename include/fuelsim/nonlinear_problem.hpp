...
class NonlinearProblem {
  public:
    ...
    virtual LocalDofs contribution_dofs(std::size_t contribution_index) const = 0;
    virtual LocalResidual contribution_residual(std::size_t contribution_index, const LocalValues& state) const = 0;
    virtual LocalSystem linearize_contribution(std::size_t contribution_index, const LocalValues& state) const = 0;
