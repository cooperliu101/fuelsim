...
inline constexpr std::array<const char*, 24> hex8_derived_field_names = {"reference_x", "reference_y", "reference_z",
    "current_x", "current_y", "current_z", "material_temperature", "integration_measure", "heat_flux_x", "heat_flux_y",
    "heat_flux_z", "logarithmic_strain_xx", "logarithmic_strain_yy", "logarithmic_strain_zz", "logarithmic_strain_xy",
    "logarithmic_strain_yz", "logarithmic_strain_xz", "infinitesimal_strain_xx", "infinitesimal_strain_yy",
