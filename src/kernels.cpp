...
Quad4RzGeometry make_quad4_rz_geometry(const Quad4Coordinates& coordinates) {
    ...
    for (std::size_t q = 0; q < locations.size(); ++q) {
        ...
        const std::array<double, quad4_node_count> derivative_xi =
            shape_derivative_xi(eta);
        const std::array<double, quad4_node_count> derivative_eta =
            shape_derivative_eta(xi);
