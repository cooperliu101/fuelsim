...
const Hex8Geometry& SpatialAssembly::region_element_geometry(
...
Quad4FaceLocalResidual SpatialAssembly::boundary_residual(
    std::size_t contribution_index, const Quad4FaceLocalValues& state) const {
    const BoundaryContribution& contribution =
        _boundary_contributions.at(contribution_index - volume_contribution_count());
...
Quad4FaceLocalSystem SpatialAssembly::boundary_system(
    std::size_t contribution_index, const Quad4FaceLocalValues& state) const {
    const BoundaryContribution& contribution =
        _boundary_contributions.at(contribution_index - volume_contribution_count());
    if (contribution.type == SpatialContributionType::pressure)
