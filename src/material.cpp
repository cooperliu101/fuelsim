...
adlite::Scalar IsotropicThermoelasticMaterial::conductivity(const adlite::Scalar& temperature) const {
...
IsotropicThermoelasticMaterial::active_properties(const adlite::Scalar& temperature) const {
...
AxisymmetricStress IsotropicThermoelasticMaterial::stress(const adlite::Scalar& strain_rr,
    ...
    return hooke_stress(active.lame_lambda, active.shear_modulus, elastic_rr, elastic_zz, elastic_hoop, strain_rz);
}
...
adlite::Scalar IsotropicInelasticMaterial::conductivity(const adlite::Scalar& temperature) const {
...
InelasticStressResponse IsotropicInelasticMaterial::response(const adlite::Scalar& strain_rr,
    ...
    const ThermoelasticProperties& thermoelastic = _thermoelastic_material.properties();
    const ActiveThermoelasticProperties active = _thermoelastic_material.active_properties(temperature);
    const adlite::Scalar thermal_strain =
        active.thermal_expansion * (temperature - thermoelastic.reference_temperature);
    const std::array<adlite::Scalar, component_count> elastic_strain = {
        strain_rr - thermal_strain - committed.plastic_strain[0] - committed.creep_strain[0],
        strain_zz - thermal_strain - committed.plastic_strain[1] - committed.creep_strain[1],
        strain_hoop - thermal_strain - committed.plastic_strain[2] - committed.creep_strain[2],
...
InelasticStressResponse IsotropicInelasticMaterial::incremental_response(
    ...
    const ActiveThermoelasticProperties old_properties = _thermoelastic_material.active_properties(old_temperature);
    const adlite::Scalar old_thermal_strain =
        old_properties.thermal_expansion * (old_temperature - thermoelastic.reference_temperature);
    const std::array<adlite::Scalar, component_count> synthetic_total = {
        committed.elastic_strain[0] + strain_increment_rr + old_thermal_strain + committed.plastic_strain[0] +
            committed.creep_strain[0],
        committed.elastic_strain[1] + strain_increment_zz + old_thermal_strain + committed.plastic_strain[1] +
            committed.creep_strain[1],
        committed.elastic_strain[2] + strain_increment_hoop + old_thermal_strain + committed.plastic_strain[2] +
            committed.creep_strain[2],
        committed.elastic_strain[3] + strain_increment_rz + committed.plastic_strain[3] + committed.creep_strain[3],
    };
