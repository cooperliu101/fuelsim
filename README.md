...
- M4.3：畸变四单元上的 100 步非共轴拉伸—剪切—反向路径达到约 `25.5°`
  转动，并含当前构形压力和分量牵引；逐步比较 MOOSE 的应力、弹性应变、
  客观总非弹性应变及塑性/蠕变等效历史；
...
压力和分量牵引。节点场和两个等效历史量的三项误差、张量历史的 L2/峰值
误差均低于 `0.5%`；换向过零处应力、弹性和总非弹性的最大逐点相对误差为
`0.3424%`、`0.5511%` 和 `0.3879%`。应力和总非弹性使用 `0.5%` 门槛，
弹性使用显式 `0.6%` qualified 门槛，不使用分母下限。
