...
机械接触、Abaqus 风格小滑移表面到面罚接触、三维 Coulomb 摩擦、三维 Exodus、结果
和检查点，以及单进程与多进程装配。HEX8 表面到面有限滑移、有限应变接触和三维增广
拉格朗日接触仍未实现。具体后端边界、分阶段范围和验收证据见
