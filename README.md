...
位移采用全场 L2 `<0.1%`、峰值 `<0.15%`、逐点 `<0.30%` 的回归门槛。
...
`0.1884%`。收紧后的径向位移峰值和逐点门槛分别为 `<0.15%` 和 `<0.30%`，
接触压力三项门槛为 `<0.12%`。积分点门槛按场分别设置：等效应力为
`0.02%/0.05%/0.05%`，塑性应变为 `0.16%/0.30%/0.32%`，蠕变应变为
`0.10%/0.20%/0.20%`，顺序均为相对 L2、相对绝对峰值和最大逐点相对误差。
